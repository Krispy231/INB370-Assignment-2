...
public class GUISimulator extends JFrame implements Runnable,ActionListener {
    ...
    public JPanel createParkPanel(){
        JFreeChart carParkChart = createChart(createDataset(), "Cars in the Park");
	...
	public GUISimulator()
	{
		...
		JTextField edtMaxCarSpaces = new JTextField(
				Integer.toString(Constants.DEFAULT_MAX_CAR_SPACES),editBoxLength);
		edtMaxCarSpaces.setPreferredSize(new Dimension(editBoxLength,editBoxHeight));
		...
		JTextField edtMaxSmallSpaces = new JTextField(
				Integer.toString(Constants.DEFAULT_MAX_SMALL_CAR_SPACES),editBoxLength);
		edtMaxSmallSpaces.setPreferredSize(new Dimension(editBoxLength,editBoxHeight));

		// Max MotorCycle Spaces Spaces
		JLabel lblMaxMotorCycleSpaces = new JLabel("Max MotorCycle Spaces:");
		lblMaxMotorCycleSpaces.setPreferredSize(new Dimension(145,textBoxHeight));
		
		JTextField edtMaxMotorCycleSpaces = new JTextField(
				Integer.toString(Constants.DEFAULT_MAX_MOTORCYCLE_SPACES),editBoxLength);
		edtMaxMotorCycleSpaces.setPreferredSize(new Dimension(editBoxLength,editBoxHeight));
		...
		JTextField edtMaxQueueSize = new JTextField(
				Integer.toString(Constants.DEFAULT_MAX_QUEUE_SIZE),editBoxLength);
		edtMaxQueueSize.setPreferredSize(new Dimension(editBoxLength,editBoxHeight));
		...
		edtRandomSeed.setPreferredSize(new Dimension(editBoxLength,editBoxHeight));
		...
		edtCarProb.setPreferredSize(new Dimension(editBoxLength,editBoxHeight));
		...
		JTextField edtSmallCarProb = new JTextField(
				Double.toString(Constants.DEFAULT_SMALL_CAR_PROB),editBoxLength);
		edtSmallCarProb.setPreferredSize(new Dimension(editBoxLength,editBoxHeight));
		...
		JTextField edtMotorCycleProb = new JTextField(
				Double.toString(Constants.DEFAULT_MOTORCYCLE_PROB),editBoxLength);
		edtMotorCycleProb.setPreferredSize(new Dimension(editBoxLength,editBoxHeight));
		...
		JTextField edtIntendedStayMean = new JTextField(
				Double.toString(Constants.DEFAULT_INTENDED_STAY_MEAN),editBoxLength);
		edtIntendedStayMean.setPreferredSize(new Dimension(editBoxLength,editBoxHeight));
